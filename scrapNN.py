...
### NN: http://www.neimanmarcus.com/All-Apparel/cat58290731_cat17740747_cat000001/c.cat#userConstrainedResults=true&refinements=&page=2&pageSize=30&sort=PCS_SORT&definitionPath=/nm/commerce/pagedef_rwd/template/EndecaDrivenHome&locationInput=&radiusInput=100&onlineOnly=&updateFilter=false&allStoresInput=false&rwd=true&catalogId=cat58290731&selectedRecentSize=&activeFavoriteSizesCount=0&activeInteraction=true

### Nordstrom
nordstromBeforePageUrl = "https://shop.nordstrom.com/c/womens-new-arrivals?origin=topnav&cm_sp=Top%20Navigation-_-Women-_-Featured-New%20Arrivals&offset=1&page="
nordstromAfterPageUrl = "&top=72"
Url = "https://shop.nordstrom.com"
### Neiman Marcus
BeforePageUrl = "http://www.neimanmarcus.com/All-Apparel/cat58290731_cat17740747_cat000001/c.cat#userConstrainedResults=true&refinements=&page="
AfterPageUrl = "&pageSize=30&sort=PCS_SORT&definitionPath=/nm/commerce/pagedef_rwd/template/EndecaDrivenHome&locationInput=&radiusInput=100&onlineOnly=&updateFilter=false&allStoresInput=false&rwd=true&catalogId=cat58290731&selectedRecentSize=&activeFavoriteSizesCount=0&activeInteraction=true"
...
for pageNum in range(1,2):
	request = urllib2.Request( BeforePageUrl + str(pageNum) + AfterPageUrl ,headers=headers)
	response = urllib2.urlopen(request).read()
